            ...
            <div class="md:w-1/2 px-8 md:px-16">
                ...
                @else
                    <form action="{{ route('register.post') }}" method="POST" class="flex flex-col gap-4">
                        ...
                        <button type="submit"
                            class="bg-[#002D74] rounded-xl text-white py-2 hover:scale-105 duration-300">Register
                        </button>
                    </form>
                @endif

                <button
                    class="my-4 flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-11 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
